...
NAME_ALIASES = {
    ...
    "americanmink": "American Mink",
    "antelopejackrabbit": "Antelope Jackrabbit",
    "barasingha": "Barasingha",
    "beceiteibex": "Beceite Ibex",
    "bengaltiger": "Bengal Tiger",
    "bighornsheep": "Bighorn Sheep",
    "blackcaiman": "Black Caiman",
    "blackgrouse": "Black Grouse",
    "bluesheep": "Blue Sheep",
    "bluewildebeest": "Blue Wildebeest",
    "cinnamonteal": "Cinnamon Teal",
    "collaredpeccary": "Collared Peccary",
    "desertbighornsheep": "Desert Bighorn Sheep",
    "duskygrouse": "Dusky Grouse",
    "eurasianpinemarten": "Eurasian Pine Marten",
    "eurasianteal": "Eurasian Teal",
    "eurasianwigeon": "Eurasian Wigeon",
    "eurasianwoodcock": "Eurasian Woodcock",
    "europeanbadger": "European Badger",
    "europeanbison": "European Bison",
    "ferruginousduck": "Ferruginous Duck",
    "genericbear_plural": "Bear",
    "harlequinduck": "Harlequin Duck",
    "hazelgrouse": "Hazel Grouse",
    "iberianmouflon": "Iberian Mouflon",
    "iberianwolf": "Iberian Wolf",
    "manitobanelk": "Manitoba Elk",
    "mountainhare": "Mountain Hare",
    "muskdeer": "Musk Deer",
    "northamericanbeaver": "North American Beaver",
    "northernpintail": "Northern Pintail",
    "northernredmuntjac": "Northern Red Muntjac",
    "rockptarmigan": "Rock Ptarmigan",
    "redgrouse": "Red Grouse",
    "rondaibex": "Ronda Ibex",
    "scrubhare": "Scrub Hare",
    "siberianweasel": "Siberian Weasel",
    "sidestripedjackal": "Side-Striped Jackal",
    "snowgoose": "Snow Goose",
    "snowleopard": "Snow Leopard",
    "southamericantapir": "South American Tapir",
    "southeasternibex": "Southeastern Spanish Ibex",
    "spectacledbear": "Spectacled Bear",
    "tibetanfox": "Tibetan Fox",
    "tuftedduck": "Tufted Duck",
    "tundrabeangoose": "Tundra Bean Goose",
    "westerncapercaillie": "Western Capercaillie",
    "westernmountaincoati": "Western Mountain Coati",
    "wildturkey": "Wild Turkey",
    "wildyak": "Wild Yak",
    "willowptarmigan": "Willow Ptarmigan",
    "woodbison": "Wood Bison",
    "woodduck": "Wood Duck",
    "woodlandcaribou": "Woodland Caribou",
    "woollyhare": "Woolly Hare",
}
